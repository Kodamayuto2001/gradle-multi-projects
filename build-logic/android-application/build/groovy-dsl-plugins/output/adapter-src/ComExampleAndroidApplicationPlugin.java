...
/**
 * Precompiled com.example.android-application script plugin.
 **/
public class ComExampleAndroidApplicationPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComExampleAndroidApplication").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComExampleAndroidApplication").asSubclass(BasicScript.class);
