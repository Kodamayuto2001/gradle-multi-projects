...
/**
 * Precompiled com.example.spring-boot-application script plugin.
 **/
public class ComExampleSpringBootApplicationPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComExampleSpringBootApplication").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.example.commons");
            target.getPluginManager().apply("org.springframework.boot");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComExampleSpringBootApplication").asSubclass(BasicScript.class);
