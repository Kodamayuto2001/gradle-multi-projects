...
/**
 * Precompiled com.example.commons script plugin.
 **/
public class ComExampleCommonsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComExampleCommons").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.example.jacoco");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComExampleCommons").asSubclass(BasicScript.class);
